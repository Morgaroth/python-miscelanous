...
class SygicLogReader(object):
    ...
    _fmt_point_elem = ["lon", "lat", "alt", "time", "speed", "signal quality", "speeding", "gsm signal quality",
                       "internet signal quality", "battery status"]
    ...
    def read_points(self):
        ...
        for i in range(self.header["point count"]):
